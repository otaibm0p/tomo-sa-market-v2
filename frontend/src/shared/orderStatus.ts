...
export const STATUS_GROUPS = {
  new: ['CREATED'] as MvpOrderStatus[],
  toPrepare: ['ACCEPTED', 'PREPARING'] as MvpOrderStatus[],
  ready: ['READY'] as MvpOrderStatus[],
  inDelivery: ['ASSIGNED', 'PICKED_UP'] as MvpOrderStatus[],
  completed: ['DELIVERED'] as MvpOrderStatus[],
  cancelled: ['CANCELLED'] as MvpOrderStatus[],
} as const
